...
class TestTwitterPipeline:
    """A class to test the TwitterPipeline class."""
    ...
    def test_transform(self, mock_twitter_data: List[SocialMediaData]) -> None:
        """Function to test the transform method of the TwitterPipeline class.
    ...
    def test_load(self, mock_twitter_data: List[SocialMediaData]) -> None:
        """Function to test the load method of the TwitterPipeline class.
